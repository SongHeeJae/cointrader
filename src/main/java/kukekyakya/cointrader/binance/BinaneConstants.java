...
public final class BinaneConstants {
	...
	public static final CandleInterval CANDLE_INTERVAL = CandleInterval.MINUTE_5;
	public static final int COUNT = 1; // {CANDLE_INTERVAL}봉 COUNT개 조회

	public static final double DIFF_PERCENT = 0.02; // 봉의 시가, 현재 종가 기준으로 이 정도 이상 차이나는 경우
	public static final double SELL_PERCENT_P = 0.03; // 양(이득)일 때 판매 퍼센트 설정
	public static final double SELL_PERCENT_M = 0.01; // 음(손해)일 때 판매 퍼센트 설정
	public static final long MINUS_CANDLE_COUNT = 12; // COUNT 보다 작아야한다.

	public static final double START_BUY_MONEY = 200; // USDT
